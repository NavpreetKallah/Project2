from builtins import tuple, list, int

import pygame


class Map:
    def __init__(self, current_map_path: list, current_map_start: tuple, current_map_end: tuple, current_map_textures: list, path_length: int):
